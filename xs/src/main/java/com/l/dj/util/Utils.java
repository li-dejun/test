...
public class Utils {
    ...
    public static String getWord(){
        String str = "慧、巧、美、颖、露、瑶、怡、婵、雁、蓓、纨、仪、荷、丹、蓉、眉、君、琴、蕊、薇、菁、梦、岚、苑、婕、馨、瑗、琰、娜、静、淑、惠、珠、翠、雅、芝、玉、萍、红、娥、玲、芬、芳、燕、彩、春、菊、兰、凤、洁、梅、琳、素、云、莲、真、环、雪、荣、爱、妹、霞、香、月、莺、媛、艳、瑞、凡、佳、嘉、琼、勤、珍、贞、莉、桂、娣、叶、璧、璐、娅、琦、晶、妍、茜、秋、珊、莎、锦、黛、青、倩、婷、姣、婉、娴、瑾、韵、融、园、艺、咏、卿、聪、澜、纯、毓、悦、昭、冰、爽、琬、茗、羽、希、宁、欣、飘、育、滢、馥、筠、柔、竹、霭、凝、晓、欢、霄、枫、芸、菲、寒、伊、亚、宜、可、姬、舒、影、荔、枝、思、丽、秀、娟、英、华、依、蓝、蝶、寻、姿、佩、怜、俞、倪、倰、偀、偲、妆、亿、曼、桃、卉、画、容、紫、宛、南、娉、朵、绮、童、桦、涵、向、映、珞、诗、婧、千、语、采、苏、萌、姝、如、夏、雨、梵、沛、汐、虹、慕、若、友、易、文、楚、彦、洋、芙、逸、媱、冉、灵、妤、雯、含、恬、以、淇、玥、白、睿、妮、苇、飞、碧、泉、儿、潼、清、金、兮、菡、苛、娇、奕、水、觅、筱、萱、蕾、初、平、然、乐、念、双、妙、安、笑、贝、惜、知、元、晴、歆、龄、忆";
        str = str.trim();
        ...
        for (String name : array ) {
            ...
            list.forEach(item -> {
                if (name != null && !"".equals(name) && name.equals(item)){
                    flag.set(false);
                }
            });
            if (flag.get()){
